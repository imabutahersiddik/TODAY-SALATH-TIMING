...
function App() {
  ...
  const [locationName, setLocationName] = useState<LocationNameType | null>(null);
  ...
  async function searchLocationName(latitude: number, longitude: number, timezone: string) {
    axios
